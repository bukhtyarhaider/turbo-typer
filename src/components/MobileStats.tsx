...
const MobileStats: React.FC<MobileStatsProps> = ({ wpm, errors, onRestart }) => {
    return (
        <div className="flex md:hidden justify-between w-full mt-4 gap-4">
             ...
             <button onClick={onRestart} className="flex-1 flex justify-center items-center bg-blue-400 border-4 border-black rounded-xl shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] active:translate-y-1 active:shadow-none">
